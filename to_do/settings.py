...
SECRET_KEY = '*=j&1a_uq33e8p4rdidr@wv)%qxnbj@w$snsr1b20a5(_t5)5+'
...
#         'NAME': 'kanban',  # 作成したデータベース名
#         'USER': 'root',  # ログインユーザー名
#         'PASSWORD': 'password',
#         'HOST': '',
#         'PORT': '',
#         'ATOMIC_REQUESTS': True, #独自追加
#     }
# }
...
DATABASES = {
    'default': {
        ...
        'PASSWORD': os.environ.get("DB_PASSWORD", "kanban"),
...
LOGOUT_REDIRECT_URL = "kanban:top"
# ログインページ
LOGIN_URL = "login"